...
public sealed class CameraDatasetStarterSession : BackgroundFrameSourceSession
{
    private static readonly string[] SupportedExtensions = [".jpg", ".jpeg", ".png", ".bmp", ".tif", ".tiff"];

    public CameraDatasetStarterSession(string sourceFolder, CameraDatasetStarterOptions options)
        : base(
    ...
    public CameraDatasetStarterOptions Options { get; }
    ...
    private static int? ResolveEstimatedFrameCount(int fileCount, CameraDatasetStarterOptions options)
    {
